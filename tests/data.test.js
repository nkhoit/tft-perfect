...
test('the application contains only Set 18', () => {
  ...
  assert.match(html, /src="saved-searches\.js\?v=milp-hybrid-v9"/);
  assert.match(html, /src="share-state\.js\?v=milp-hybrid-v9"/);
...
test('v7 assets revalidate without weakening immutable vendor caching', () => {
  ...
  assert.match(html, /style\.css\?v=milp-hybrid-v9/);
  assert.match(html, /search-utils\.js\?v=milp-hybrid-v9/);
  assert.match(html, /solver-scheduler\.js\?v=milp-hybrid-v9/);
  assert.match(html, /app\.js\?v=milp-hybrid-v9/);
  assert.match(app, /solver-worker\.js\?v=milp-hybrid-v9/);
